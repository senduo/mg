...
OBJS	 =	autoexec.o basic.o buffer.o cinfo.o dir.o display.o \
		...
		window.o word.o yank.o cmode.o dired.o grep.o theo.o \
...
OBJS	+=	openbsd-compat/strtonum.o openbsd-compat/strlcpy.o \
		...
		openbsd-compat/fparseln.o openbsd-compat/bsd-arc4random.o \
		openbsd-compat/entropy.o openbsd-compat/bdirname.o
